# eval import
from my_yolact.yolact_edge.data import COCODetection, YoutubeVIS, get_label_map, MEANS, COLORS
from my_yolact.yolact_edge.data import cfg, set_cfg, set_dataset
from my_yolact.yolact_edge.yolact import Yolact
from my_yolact.yolact_edge.utils.augmentations import BaseTransform, BaseTransformVideo, FastBaseTransform, Resize
from my_yolact.yolact_edge.utils.functions import MovingAverage, ProgressBar
from my_yolact.yolact_edge.layers.box_utils import jaccard, center_size
from my_yolact.yolact_edge.utils import timer
from my_yolact.yolact_edge.utils.functions import SavePath
...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=True, mask_alpha=1):
    """
