...
parser.add_argument('--bbox_det_file', default='/home/chris/workspace/yolact_edge/results/bbox_detections.json', type=str)
parser.add_argument('--mask_det_file', default='/home/chris/workspace/yolact_edge/results/mask_detections.json', type=str)
parser.add_argument('--gt_ann_file',   default='/home/chris/workspace/yolact_edge/results/instances_val2017.json', type=str)
