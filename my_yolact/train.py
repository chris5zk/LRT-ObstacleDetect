...
from my_yolact.yolact_edge.data import *
from my_yolact.yolact_edge.utils.augmentations import SSDAugmentation, SSDAugmentationVideo, BaseTransform, BaseTransformVideo
from my_yolact.yolact_edge.utils.functions import MovingAverage, SavePath
from my_yolact.yolact_edge.layers.modules import MultiBoxLoss
from my_yolact.yolact_edge.layers.modules.optical_flow_loss import OpticalFlowLoss
...
import argparse
import datetime
from my_yolact.yolact_edge.utils.tensorboard_helper import SummaryHelper
import my_yolact.yolact_edge.utils.misc as misc
...
parser.add_argument('--save_folder', default='/home/chris/workspace/yolact_edge/weights/',
...
parser.add_argument('--validation_size', default=482, type=int,
...
def train(rank, args):
    ...
    from my_yolact.yolact_edge.data.sampler_utils import InfiniteSampler, build_batch_data_sampler
